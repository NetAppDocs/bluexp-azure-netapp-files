...
* *Details & Tags*: Enter a volume name and size, the VNet and subnet where the volume should reside, and optionally specify tags for the volume. You can also choose to the networking type. Choose Standard to support VNet features or Basic have reduced IP limits (<1000) and no additional VNet features for the volume.
+
