...
+
You also need to select the networking type you want to use. Choose *Standard* to support VNet features or *Basic* have reduced IP limits (<1000) and no additional VNet features for the volume.
+
