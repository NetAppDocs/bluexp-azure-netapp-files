...
+
*Network features*: Select the network features for the volume. Choose *Standard* to support VNet features or *Basic* have reduced IP limits (<1000) and no additional VNet features for the volume.
+
